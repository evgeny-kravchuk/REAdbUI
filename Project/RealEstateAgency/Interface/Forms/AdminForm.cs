...
namespace Interface.Forms
{
    public partial class AdminForm : Form
    {
        ...
        #region Staff
        #region TextBox
        public string id_staff { get { return textBoxStaffId.Text; } set { textBoxStaffId.Text = string.Empty; textBoxStaffId.Text = value; } }
        ...
        public string password_staff { get { return textBoxStaffPassword.Text; } set { textBoxStaffPassword.Text = string.Empty; textBoxStaffPassword.Text = value; } }
        
        public string lastName_staff { get { return Functions.FirstUpper(textBoxStaffLastName.Text); } set { textBoxStaffLastName.Text = string.Empty; textBoxStaffLastName.Text = value; } }
        public string firstName_staff { get { return Functions.FirstUpper(textBoxStaffFirstName.Text); } set { textBoxStaffFirstName.Text = string.Empty; textBoxStaffFirstName.Text = value; } }
        public string patronymic_staff { get { return Functions.FirstUpper(textBoxStaffPatronymic.Text); } set { textBoxStaffPatronymic.Text = string.Empty; textBoxStaffPatronymic.Text = value; } }
        ...
        public string position_staff { get { return comboBoxStaffPosition.Text; } set { comboBoxStaffPosition.Text = string.Empty; comboBoxStaffPosition.Text = value; } }
        ...
        public string dateOfBirth_staff { get { return dtpStaffBirth.Text; } set { dtpStaffBirth.Text = string.Empty; dtpStaffBirth.Text = value; } }
        #endregion

        #region Buttons 
        public Button addStaff { get { return btnAddStaff; } }
        public Button updateStaff { get { return btnUpdateStaff; } }
        public Button deleteStaff { get { return btnDeleteStaff; } }
        #endregion

        #region DataGrid
        public DataGridView datagridviewStaff { get { return dgvStaff; } }
        #endregion
        ...
        #region Обработка события кнопки Добавить Сотрудника
        ...
        #region Обработка события кнопки Удалить Сотрудника
        private void DeleteStaff_Click(object sender, EventArgs e) { }
        #endregion

        #region Обработка события кнопки Очистить поля
        private void ClearField_Staff(object sender, EventArgs e)
        {
            textBoxStaffId.Text = string.Empty;
            textBoxStaffLogin.Text = string.Empty;

            textBoxStaffLastName.Text = string.Empty;
            textBoxStaffFirstName.Text = string.Empty;
            textBoxStaffPatronymic.Text = string.Empty;

            comboBoxStaffSex.Text = string.Empty;
            dtpStaffBirth.Text = string.Empty;
            comboBoxStaffPosition.Text = string.Empty;
            maskedTextBoxStaffPhoneNumber.Text = string.Empty;
        }
        #endregion
        #endregion
        ...
        #region Position
        #region TextBox        
        public string positionName_position { get { return Functions.FirstUpper(comboBoxPositionName.Text); } set { comboBoxPositionName.Text = string.Empty; comboBoxPositionName.Text = value; } }
        public string salary_position { get { return textBoxPositionSalary.Text; } set { textBoxPositionSalary.Text = string.Empty; textBoxPositionSalary.Text = value; } }
        #endregion

        #region Buttons
        public Button updatePosition { get { return btnUpdatePosition; } }
        #endregion

        #region  DataGrid
        public DataGridView datagridviewPosition { get { return dgvPosition; } }
        #endregion
        ...
        #region Обработка события кнопки Обновить должность
        private void UpdatePosition_Click(object sender, EventArgs e) { }
        #endregion

        #region Обработка события кнопки Очистить поля
        private void ClearField_Position(object sender, EventArgs e)
        {
            comboBoxPositionName.Text = string.Empty;
            textBoxPositionSalary.Text = string.Empty;
        }
        #endregion
        #endregion
        ...
        private void ClearField_Flat(object sender, EventArgs e)
        {
            ...
            //textBoxFlatCity.Text = string.Empty;
            ...
            //comboBoxFlatType.Text = string.Empty;
        ...
        #region Обработка события кнопки Добавить Редактировать Удалить Искомую Квартиру
        ...
        public string password_client { get { return textBoxClientPassword.Text; } set { textBoxClientPassword.Text = string.Empty; textBoxClientPassword.Text = value; } }
        ...
        #region Buttons 
        public Button addClient { get { return btnAddClient; } }
        public Button updateClient { get { return btnUpdateClient; } }
        public Button deleteClient { get { return btnDeleteClient; } }
        #endregion
        ...
        private void ClearField_Client(object sender, EventArgs e)
        {
            ...
            textBoxClientLogin.Text = string.Empty;
        ...
        public Button deleteContract { get { return btnDeleteContract; } }
        #endregion
