namespace Objects.Tables
{
    public class TableHouse
    {
        ...
        public TableHouse(string id_object, string id_owner, string PostCode, string City, string Hood, string Street, string HouseNumber, string FlatNumber, string Type, string Area, string Status, string NumberOfStoreys, string Room, string Price)
        {
