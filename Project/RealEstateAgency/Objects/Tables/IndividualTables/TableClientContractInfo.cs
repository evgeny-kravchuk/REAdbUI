...
{
    public class TableClientContractInfo
    {
        ...
        public TableClientContractInfo() { }

        public TableClientContractInfo(string City, string Street, string HouseNumber, string FlatNumber, string ContractType, string StartDate, string FinishDate, string Price)
        {
            this.City = City;
            this.Street = Street;
